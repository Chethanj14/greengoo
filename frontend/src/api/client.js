...
const API_BASE = import.meta.env.PROD
  ? 'https://greengoo.onrender.com/api'
  : '/api'
...
export const addToWishlist = (productId, sessionId) =>
  api.post('/wishlist', {
    product_id: productId,
    session_id: sessionId || '',
  })

export const removeFromWishlist = (productId, sessionId) =>
  api.delete(`/wishlist/${productId}`, {
    params: sessionId ? { session_id: sessionId } : {},
  })

// Care Articles
export const getCareArticles = () =>
  api.get('/care-articles')

export const getCareArticle = (slug) =>
